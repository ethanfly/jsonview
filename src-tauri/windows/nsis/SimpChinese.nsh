; Tauri NSIS installer - Simplified Chinese
...
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "不卸载（此安装程序不允许在未卸载的情况下降级）"
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法结束 {{product_name}} 进程。请先手动关闭后再试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2..."
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "已安装更新版本的 ${PRODUCTNAME}！不建议安装旧版本。若确需安装旧版，请先卸载当前版本。请选择操作并点击“下一步”继续。"
LangString older ${LANG_SIMPCHINESE} "旧版"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "您的系统上已安装 $R4 版本的 ${PRODUCTNAME}。建议在安装前先卸载当前版本。请选择操作并点击“下一步”继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装程序不允许静默降级，请使用图形界面安装。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "WebView2 安装失败！应用无法在没有 WebView2 的情况下运行。请尝试重新运行安装程序。"
